...
public class Main {
    public static void main(String[] args) {
        ...
        service.add(new TurnOnRate("pishi", "Включайся Пиши", "Кино и сериалы в мегафон ТВ", 650, "Безлимитный интернет", 1200, 300, true));
        service.add(new TurnOnRate("obschaysya", "Включайся Общайся", "Всегда на связи", 350, "Безлимитный интернет", 600, 0, true));
